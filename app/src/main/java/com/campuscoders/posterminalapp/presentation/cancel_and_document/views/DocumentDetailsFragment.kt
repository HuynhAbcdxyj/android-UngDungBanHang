        ...
        viewModel.statusCancelSale.observe(viewLifecycleOwner) {
            when(it) {
                is Resource.Success -> {
                    ...
                    textViewCancelSale.text = "Tài liệu điện tử đã bị hủy"
                    textViewSaleTotal.text = cost
                    textViewOrderNo.text = documentNo
                }
                is Resource.Loading -> {
                    textViewCancelSale.text = "Tài liệu điện tử đang bị hủy bỏ"
                ...
                is Resource.Error -> {
                    textViewCancelSale.text = "Tài liệu điện tử không thể bị hủy!"
